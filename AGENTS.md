...
App: **build-e2e455** at https://build-e2e455.vibekit.bot
Repo: template/blank | Port: 4130

## NEVER (these break the product)
- **NEVER point the user at localhost / `npm start`** — only **https://build-e2e455.vibekit.bot**. They have no terminal.
